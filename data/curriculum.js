...
window.CURRICULUM = {
  ...
  modules: [
    ...
    { id:'m2', title:'מקימים את החנות', icon:'🏗️', lessons:[
    ...
    { id:'m3', title:'האפליקציות החיוניות', icon:'🧩', lessons:[
    ...
    { id:'m4', title:'מוצרים — מה למכור', icon:'📦', lessons:[
    ...
    { id:'m5', title:'דף מוצר ממיר (קופירייטינג)', icon:'✍️', lessons:[
    ...
    { id:'m6', title:'עיצוב החנות', icon:'🎨', lessons:[
    ...
    { id:'m7', title:'להעלות את סל הקנייה (AOV)', icon:'💰', lessons:[
    ...
    { id:'m8', title:'דפים חוקיים, תפריטים ומעקב', icon:'⚖️', lessons:[
    ...
    { id:'m9', title:'הגדרות החנות', icon:'⚙️', lessons:[
    ...
    { id:'m10', title:'סליקה — לקבל תשלומים', icon:'💳', lessons:[
    ...
    { id:'m11', title:'ההזמנה הראשונה', icon:'🔔', lessons:[
    ...
    { id:'m12', title:'מה באמת עושה כסף — 5 העמודים', icon:'🚀', lessons:[
